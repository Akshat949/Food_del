  ...
  return (
    <form onSubmit={placeOrder} className="place-order">
      <div className="place-order-left">
        ...
        <input required name="email" onChange={onChange} value={data.email} type="email" placeholder="Email address" />
        ...
        <div className="multi-fields">
          ...
          <input required name="country" onChange={onChange} value={data.country} type="text" placeholder="Country" />
        </div>
